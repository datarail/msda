...
def Main():
	...
	sys.stderr.write('\n')
        #print('--------------')
        # print(len(netphorestTmpFiles), netphorestTmpFiles[0].name)
        #print('---------------')
...
if __name__ == '__main__':
	...
	parser.add_option("-d", "--data", dest="datadir", default=os.path.join(os.path.split(os.path.realpath(sys.argv[0]))[0], 'data'),
        ...
        parser.add_option("--tmp", dest="tmpdir", default='/output',
